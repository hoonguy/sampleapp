...
function App({
  ...
  const [page, setPage] = (0, _react.useState)(param);
  (0, _react.useEffect)(() => {
    window.onpopstate = event => {
      // call by back button at browser
      setPage(evetn.state);
    };
  }, []);
  ...
  ;
  const PageComponent = page === 'home' ? _Home.default : _About.default; // rendering page upon to address
